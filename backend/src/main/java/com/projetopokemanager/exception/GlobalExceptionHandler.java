...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(InvalidCollectionDataException.class)
    public ResponseEntity<ErrorResponseDTO> handleInvalidCollectionData(InvalidCollectionDataException ex) {
        ErrorResponseDTO error = new ErrorResponseDTO(
                LocalDateTime.now(),
                HttpStatus.BAD_REQUEST.value(),
                "Bad Request",
    ...
    @ExceptionHandler({TeamFullException.class, DuplicatePokemonInTeamException.class})
    public ResponseEntity<ErrorResponseDTO> handleTeamRuleViolation(RuntimeException ex) {
        ErrorResponseDTO error = new ErrorResponseDTO(
                LocalDateTime.now(),
                HttpStatus.BAD_REQUEST.value(),
                "Bad Request",
